...
組み込み関数は、CPython 本体の Cソースコードで定義されます。
print 関数の実体は [こちら](https://github.com/python/cpython/blob/v3.11.2/Python/bltinmodule.c#L1986)から確認できます。
print 関数に該当する部分は、前述の通り `builtin_print_impl`です。
